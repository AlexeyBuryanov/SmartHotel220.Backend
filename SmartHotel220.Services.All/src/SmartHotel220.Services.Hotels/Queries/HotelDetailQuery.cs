...
{
    /// <summary>
    /// Запросы связанные с подробностями / деталями отеля
    /// </summary>
    public class HotelDetailQuery
    {
        ...
        public async Task<IEnumerable<RoomDetail>> GetRoomsByHotel(int hotelId)
        {
            ...
            rooms.ForEach(rd => rd.Pictures = Enumerable.Range(1, rd.NumPhotos)
